...
function testGloballyDefinedAttributeThatIsOverriddenForOtherElement() {
  ...
  assertEquals(
      security.html.contracts.AttrType.TRUSTED_RESOURCE_URL,
      security.html.contracts.typeOfAttribute(
          'iframe', 'src', goog.functions.NULL));
}
...
function testElementSpecificAttribute() {
  assertEquals(
      security.html.contracts.AttrType.SAFE_HTML,
      security.html.contracts.typeOfAttribute(
          'iframe', 'srcdoc', goog.functions.NULL));
}
...
function testTypeOfText() {
  ...
  assertEquals(
      ...
      security.html.contracts.contentTypeForElement('textarea'));
  assertEquals(
      security.html.contracts.ElementContentType.STRING_RCDATA,
      security.html.contracts.contentTypeForElement('title'));
  assertEquals(
