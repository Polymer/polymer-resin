...
security.html.contracts.isEnumValueAllowed =
  ...
  if (typeof valueSetIndex !== 'number') {
    attrToValueSetIndex =
...
security.html.contracts.GLOBAL_ATTRS_ = {
  ...
  'aria-activedescendant': security.html.contracts.AttrType.IDENTIFIER,
  'aria-atomic': security.html.contracts.AttrType.NONE,
  'aria-autocomplete': security.html.contracts.AttrType.NONE,
  'aria-busy': security.html.contracts.AttrType.NONE,
  'aria-checked': security.html.contracts.AttrType.NONE,
  'aria-disabled': security.html.contracts.AttrType.NONE,
  'aria-dropeffect': security.html.contracts.AttrType.NONE,
  'aria-expanded': security.html.contracts.AttrType.NONE,
  'aria-haspopup': security.html.contracts.AttrType.NONE,
  'aria-hidden': security.html.contracts.AttrType.NONE,
  'aria-invalid': security.html.contracts.AttrType.NONE,
  'aria-label': security.html.contracts.AttrType.NONE,
  'aria-level': security.html.contracts.AttrType.NONE,
  'aria-live': security.html.contracts.AttrType.NONE,
  'aria-multiline': security.html.contracts.AttrType.NONE,
  'aria-multiselectable': security.html.contracts.AttrType.NONE,
  'aria-orientation': security.html.contracts.AttrType.NONE,
  'aria-posinset': security.html.contracts.AttrType.NONE,
  'aria-pressed': security.html.contracts.AttrType.NONE,
  'aria-readonly': security.html.contracts.AttrType.NONE,
  'aria-relevant': security.html.contracts.AttrType.NONE,
  'aria-required': security.html.contracts.AttrType.NONE,
  'aria-selected': security.html.contracts.AttrType.NONE,
  'aria-setsize': security.html.contracts.AttrType.NONE,
  'aria-sort': security.html.contracts.AttrType.NONE,
  'aria-valuemax': security.html.contracts.AttrType.NONE,
  'aria-valuemin': security.html.contracts.AttrType.NONE,
  'aria-valuenow': security.html.contracts.AttrType.NONE,
  'aria-valuetext': security.html.contracts.AttrType.NONE,
  ...
  'contenteditable': security.html.contracts.AttrType.NONE,
  ...
  'enctype': security.html.contracts.AttrType.NONE,
  'face': security.html.contracts.AttrType.NONE,
  'for': security.html.contracts.AttrType.IDENTIFIER,
  'formenctype': security.html.contracts.AttrType.NONE,
  ...
  'itemid': security.html.contracts.AttrType.NONE,
  'itemprop': security.html.contracts.AttrType.NONE,
  'itemref': security.html.contracts.AttrType.NONE,
  'itemscope': security.html.contracts.AttrType.NONE,
  'itemtype': security.html.contracts.AttrType.NONE,
...
security.html.contracts.ELEMENT_CONTRACTS_ = {
  ...
  'img': {
    ...
    'srcset': [
      {
        contract: security.html.contracts.AttrType.SAFE_URL_SET,
      },
    ],
  },
  'input': {
...
security.html.contracts.ELEMENT_CONTENT_TYPES_ = {
  ...
  'content': security.html.contracts.ElementContentType.SAFE_HTML,
